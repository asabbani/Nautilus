...
class Main(Thread):
    def __init__(self, q_out):
        ...
        self.root.geometry(str(int(WIDTH/multiplier)) + "x" + str(int(HEIGHT/multiplier))) 

        # Begin defining instance variables
        self.root.title("Yonder Arctic OPS")
        self.q_out = q_out
        self.top_frame = Frame(self.root, bd = 1) 
        self.top_frame.pack( fill = BOTH, side = TOP, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, expand = YES)

        self.bot_frame = Frame(self.root, bd = 1)
        self.bot_frame.pack( fill = BOTH, side = BOTTOM, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, expand = YES)
    ...
    def init_function_frame(self):
        ...
        self.functions_frame.pack( padx = MAIN_PAD_X, pady = MAIN_PAD_Y, side = LEFT, fill=Y, expand = NO)
    ...
    def init_map_frame(self):
        ...
        self.map_frame.pack( fill = BOTH, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, side = LEFT, expand = YES)
    ...
    def init_status_frame(self):
        ...
        self.status_frame.pack(fill = BOTH, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, side = LEFT, expand = NO)
    ...
    def init_log_frame(self):
        ...
        self.log_frame.pack( fill = BOTH, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, side = LEFT, expand = YES)
    ...
    def init_calibrate_frame(self): 
        ...
        self.calibrate_frame.pack( fill = Y, padx = MAIN_PAD_X, pady = MAIN_PAD_Y, side = LEFT, expand = NO)
    ...
    def init_mission_frame(self):
        ...
        self.mission_frame.pack( fill = Y, padx = COMBO_PAD_X, pady = COMBO_PAD_Y, side = LEFT, expand = NO)
